...
namespace Bug_Tracker.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> DemoLogin(string Role)
        {
            ...
            {
                case "DemoAdmin":
                    demoUserName = WebConfigurationManager.AppSettings["DemoAdmin"];
                    break;
                case "DemoPM":
                    demoUserName = WebConfigurationManager.AppSettings["DemoPm"];
                    break;
                case "DemoDeveloper":
                    demoUserName = WebConfigurationManager.AppSettings["DemoDeveloper"];
                    break;
                case "DemoSubmitter":
                    demoUserName = WebConfigurationManager.AppSettings["DemoSubmitter"];
                    break;
                default:
                    break;
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, HttpPostedFileBase image)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, DisplayName = model.DisplayName, Avatar = model.Avatar };
                var result = await UserManager.CreateAsync(user, model.Password);
                
                //var fileName = Path.GetFileName(image.FileName);
                //image.SaveAs(Path.Combine(Server.MapPath("~/Uploads/"), fileName));
                //model.Avatar = "/Uploads/Avatar/" + fileName;
